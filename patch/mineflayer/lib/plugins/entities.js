...
function inject (bot) {
  ...
  bot._client.on('entity_status', (packet) => {
    ...
    if (eventName === 'entityHandSwap' && entity.equipment) {
      ...
      const desc =
        Object.getOwnPropertyDescriptor(entity, 'heldItem') ||
        Object.getOwnPropertyDescriptor(Object.getPrototypeOf(entity), 'heldItem')

      if (!desc || desc.writable || desc.set) {
        entity.heldItem = entity.equipment[0]
      }
    }
