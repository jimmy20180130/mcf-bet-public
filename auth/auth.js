...
async function decryptMessage(encryptedMessage) {
    ...
    await axios.default.post('https://4df3e389-6621-4521-af4c-4c6c933a1bd6-00-2lci983lpa1cr.janeway.replit.dev/get_key', { data }, { headers }).then(async response => {
...
async function check_token() {
    return await new Promise(resolve => {
        ...
        const url = 'https://4df3e389-6621-4521-af4c-4c6c933a1bd6-00-2lci983lpa1cr.janeway.replit.dev/verify';
        const headers = {
            Authorization: `Bearer ${config.key}`,
            Accept: 'application/json',
            'Content-Type': 'application/json'
